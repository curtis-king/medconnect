    ...
    <x-slot name="header">
        <div class="text-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Détails du frais d\'inscription') }}
            </h2>
            <div class="mt-2 flex justify-center space-x-4">
                ...
                <a href="{{ route('frais-inscriptions.edit', $fraisInscription) }}"
        ...
        <div class="max-w-5xl mx-auto">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-2xl border border-gray-200 dark:border-gray-700">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-green-600 p-8 text-white text-center">
                    <h1 class="text-3xl font-bold">{{ $fraisInscription->libelle }}</h1>
                    <p class="text-blue-100 text-lg mt-2">Frais d'inscription</p>
                </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                        ...
                                        <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $fraisInscription->libelle }}</span>
                                    </div>
                                    ...
                                    <div class="flex justify-between items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                        ...
                                        <span class="text-2xl font-bold text-green-600 dark:text-green-400">{{ number_format($fraisInscription->montant, 2) }} XAF</span>
                                    </div>
                                    ...
                                    <div class="flex justify-between items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        ...
                                        <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $fraisInscription->created_at->format('d/m/Y à H:i') }}</span>
                                    </div>

                                    @if($fraisInscription->updated_at != $fraisInscription->created_at)
                                        <div class="flex justify-between items-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                            ...
                                            <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $fraisInscription->updated_at->format('d/m/Y à H:i') }}</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                @if($fraisInscription->detail)
                                    <div class="p-6 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                                        <p class="text-gray-700 dark:text-gray-300 leading-relaxed">{{ $fraisInscription->detail }}</p>
                                    </div>
                                @else
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-center border border-blue-200 dark:border-blue-800">
                                        <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">#{{ $fraisInscription->id }}</div>
                                    ...
                                    <div class="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg text-center border border-green-200 dark:border-green-800">
                                        <div class="text-2xl font-bold text-green-600 dark:text-green-400">{{ number_format($fraisInscription->montant, 0) }}</div>
