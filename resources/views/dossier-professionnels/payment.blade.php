    ...
    <x-slot name="header">
        <div class="text-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                Paiement d'inscription professionnelle
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl overflow-hidden">
                <div class="bg-gradient-to-r from-emerald-600 to-teal-500 px-6 py-4">
                    <h3 class="text-white font-semibold text-lg">Finaliser votre demande pro</h3>
                    <p class="text-emerald-100 text-sm mt-1">Compte: {{ $dossierProfessionnel->user->name }}</p>
                </div>

                <div class="p-6 space-y-5">
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                        <p class="text-sm text-gray-700 dark:text-gray-200">Montant d'inscription professionnelle</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">
                            {{ number_format((float) ($dossierProfessionnel->frais?->prix ?? 0), 0, ',', ' ') }} XAF
                        </p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Validation finale du statut professionnel par un administrateur apres verification.</p>
                    </div>
