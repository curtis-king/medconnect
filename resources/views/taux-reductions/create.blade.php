    ...
    <div class="py-16 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-2xl border border-gray-200 dark:border-gray-700">
                <div class="p-10">
                    <form method="POST" action="{{ route('taux-reductions.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="taux" type="number" name="taux" value="{{ old('taux') }}" required step="0.01" min="0" max="100"
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input id="actif" type="checkbox" name="actif" value="1" {{ old('actif', true) ? 'checked' : '' }}
                        ...
                        <div>
                            ...
                            <textarea id="detail" name="detail" rows="4"
                                ...
                                placeholder="Description détaillée du taux de réduction...">{{ old('detail') }}</textarea>
